...
// Calculate performance metrics once for reuse
$performance_metrics = [
...
$architecture_benefits = [
    'scalability' => [
        ...
        'implementation' => 'Primary ASG: awseb-e-rpyapuixkj-stack-AWSEBAutoScalingGroup-nWac0TXhUHa4 scales from 2 to 8 instances based on network traffic thresholds (60% scale-out, 30% scale-in)',
        'benefit' => 'Handles unpredictable growth without over-provisioning, maintaining cost efficiency',
        'technical_details' => 'Current instances: i-0fdc269d453d60316 (us-east-1b), i-07d65eeddeaab6735 (us-east-1a) with 360s cooldown'
    ],
    'high_availability' => [
        'title' => 'High Availability',
        'description' => 'Multi-AZ deployment ensures continuous service availability',
        'implementation' => 'RDS Multi-AZ: lamp-app-db (MySQL 8.0.41) with automatic failover, Load Balancer: awseb-e-r-AWSEBLoa-ID4G50DGRVZZ across us-east-1a/us-east-1b',
        'benefit' => 'Maintains service during AZ failures, database failover, and maintenance windows',
        'technical_details' => 'Health checks every 10s (TCP:80), VPC: vpc-0164bd99719cccfbd with subnets in multiple AZs'
    ],
    'fault_tolerance' => [
        'title' => 'Fault Tolerance',
        'description' => 'System continues operating despite component failures',
        'implementation' => 'Database automatic failover between AZs, Auto Scaling instance replacement, ELB health monitoring with immediate traffic redirection',
        'benefit' => 'Automatic recovery from hardware/software failures with zero manual intervention',
        'technical_details' => 'Security Groups: sg-041d48777e9ea0c1ae (instances), sg-07cd2bd576fa91e56 (ELB) with consistent protection'
    ],
    'disaster_recovery' => [
        'title' => 'Disaster Recovery',
        'description' => 'Comprehensive backup and recovery mechanisms',
        'implementation' => 'RDS automated backups, Custom AMIs: ami-040d931d2f7f2341c (LAMP-Stack-Custom-AMI), ami-00ffa1ae9aa59036d (custom-lamp-ami), cross-AZ replication',
        'benefit' => 'Rapid recovery from disasters with minimal data loss and RTO < 5 minutes',
        'technical_details' => 'Multiple database instances: lamp-app-db, custom-lamp-db with 20GB storage and backup retention'
    ],
    'elasticity' => [
        'title' => 'Elastic Resources',
        'description' => 'Resources automatically adjust to actual demand',
        'implementation' => 'Auto Scaling: min 2, max 8 instances with network-based triggers, Elastic Beanstalk: lamp-prod-vpc environment with platform 64bit Amazon Linux 2 v3.9.2 running PHP 8.1',
        'benefit' => 'Cost optimization through dynamic resource allocation - only pay for what you use',
        'technical_details' => 't3.micro instances optimized for burstable workloads, automatic capacity adjustment based on real-time metrics'
    ],
    'monitoring' => [
        'title' => 'Comprehensive Monitoring',
        'description' => 'Real-time monitoring and alerting for all components',
        'implementation' => 'CloudWatch metrics integrated with SNS: lamp-app-notifications, lamp-env-notifications, RedshiftSNS for comprehensive coverage',
        'benefit' => 'Proactive issue detection with automated response and immediate email notifications',
        'technical_details' => 'Email alerts to anika.arman@student.uts.edu.au for scaling events, health changes, deployments, and failures'
    ]
];
