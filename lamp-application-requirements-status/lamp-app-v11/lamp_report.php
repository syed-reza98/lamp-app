...
<head>
    ...
    <link rel="stylesheet" href="enhanced_visuals.css">
    <link rel="stylesheet" href="architecture_refined.css">
...
<body>
            ...
            <div class="header-content">
                ...
                <div class="header-description">
                    ...
                    <div style="margin-top: 15px; text-align: center;">
                        <a href="formal_report.php" style="background: #2c3e50; color: white; padding: 12px 24px; text-decoration: none; border-radius: 5px; font-weight: bold; margin: 5px; display: inline-block;">
                            📋 View Formal Academic Report
                        </a>
                        <a href="architecture_diagram_standalone.php" target="_blank" style="background: #27ae60; color: white; padding: 12px 24px; text-decoration: none; border-radius: 5px; font-weight: bold; margin: 5px; display: inline-block;">
    ...
    </section> <!-- AWS Requirements Implementation -->
        ...
        <div class="container">
            ...
            <div class="responsive-grid">
                <?php foreach ($aws_requirements as $letter => $requirement): ?>
                    <div class="card requirement-card hover-lift">
    ...
    <section class="section architecture-section">
        <div class="container">
            ...
            <?php
            // Include and display the optimized architecture diagram
    ...
    <!-- Architecture Interactive Enhancements -->
    <script src="architecture_interactive.js"></script>
</body>
