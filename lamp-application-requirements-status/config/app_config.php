...
$config = [
    'database' => [
        'hostname' => $_SERVER['RDS_HOSTNAME'] ?? 'lamp-app-db.cijnrr1efnu0.us-east-1.rds.amazonaws.com',
        'port' => $_SERVER['RDS_PORT'] ?? '3306',
        'database' => $_SERVER['RDS_DB_NAME'] ?? 'lampapp',
        'username' => $_SERVER['RDS_USERNAME'] ?? 'lampdbadmin',
        'password' => $_SERVER['RDS_PASSWORD'] ?? 'SecurePass123!',
        'charset' => 'utf8mb4',
