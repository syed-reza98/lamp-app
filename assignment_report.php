    ...
    <body>
        <div class="container">
            ...
            <div class="section">
                ...
                <div class="section-content">                    <h3>Current Situation & Migration Challenge</h3>
                    <p style="font-size: 1.1em; margin-bottom: 20px;">
                        A small startup currently in its early stages of operation has their setup comprising a 
                        <strong>LAMP stack (MySQL, Apache, and PHP) running on a single desktop PC</strong> in a small office.
                        Like many early-stage startups, it expects <strong>significant, rapid, and unpredictable growth</strong> 
                    ...
                    <div class="alert alert-info">
                        ...
                        explicitly address the concerns outlined in the project brief, ensuring it meets all specified requirements.
                    </div>
                </div>
            </div>
            ...
            <div class="section">
                ...
                <div class="section-content">
                    ...
                    </p>                    <div class="architecture-diagram">
                        ┌─────────────────────────────────────────────────────────────────────────────────────┐
                        │                             INTERNET USERS                                           │
                        └──────────────────────────────┬──────────────────────────────────────────────────────┘
                                                       │ HTTP/HTTPS Requests
                    ...
                    <div class="alert alert-success">
                        ...
                        failover,
                        load distribution, database redundancy, and comprehensive monitoring - directly addressing the
                        startup's
                        scalability and disaster recovery concerns.
                    </div>
                </div>
            </div>
            ...
            <div class="section">
                ...
                <div class="section-content">
                    ...
                    </p>                    <div class="assumptions-list">
                        <ul>
                            <li><strong>Current Infrastructure:</strong> Single desktop PC with LAMP stack requires complete cloud migration</li>
                            <li><strong>Growth Pattern:</strong> Significant, rapid, and unpredictable growth expected in coming months</li>
                            <li><strong>Budget Constraints:</strong> Early-stage startup budget favors cost-effective t3.micro instances</li>
                            <li><strong>Geographic Deployment:</strong> Initial deployment in US East (N. Virginia) region for optimal performance</li>
                            <li><strong>Availability Target:</strong> 99.9% uptime requirement with automated failover capabilities</li>
                            <li><strong>Scaling Requirements:</strong> Auto Scaling based on network output traffic (60%/30% thresholds as mandated)</li>
                            <li><strong>Instance Range:</strong> 2-8 EC2 instances as specified in assignment requirements</li>
                            <li><strong>Database Platform:</strong> MySQL compatibility required for existing application code</li>
                            <li><strong>Security Model:</strong> Public subnets with security groups controlling HTTP/SSH access</li>
                            <li><strong>Key Management:</strong> Single custom key pair across all instances for administrative consistency</li>
                            <li><strong>Disaster Recovery RTO:</strong> ≤15 minutes recovery time with Multi-AZ RDS deployment</li>
                            <li><strong>Monitoring Scope:</strong> Email notifications for environment events and scaling activities</li>
                            <li><strong>Platform Consistency:</strong> Custom AMI ensures identical LAMP configuration across all instances</li>
                            <li><strong>Load Balancing:</strong> Classic Load Balancer suitable for HTTP/HTTPS traffic distribution</li>
                            <li><strong>Future Scalability:</strong> Architecture designed to accommodate additional services (CDN, caching, etc.)</li>
                        </ul>
                    </div>
                    ...
                    <div class="config-grid">
                        <div class="config-item" style="border-left-color: #f39c12;">
                            ...
                            <div class="config-value">All 10 specified services (a-j) must be implemented exactly as required</div>
                        </div>
                        <div class="config-item" style="border-left-color: #e74c3c;">
                            <div class="config-label">Network Configuration</div>
                            <div class="config-value">Custom VPC with public subnets in different AZs, same security group all instances</div>
                        </div>
                        <div class="config-item" style="border-left-color: #27ae60;">
                            <div class="config-label">Scaling Specifications</div>
                            <div class="config-value">Network output traffic triggers: 60% upper, 30% lower threshold</div>
                        </div>
                        <div class="config-item" style="border-left-color: #3498db;">
                            <div class="config-label">Deployment Platform</div>
                            <div class="config-value">AWS Elastic Beanstalk as primary deployment and management platform</div>
                        </div>
                    </div>
            ...
            <div class="footer">
                ...
                <p>Live Environment URL: <a
                        href="http://lamp-prod-vpc.eba-qcb2embn.us-east-1.elasticbeanstalk.com/assignment_report.php"
