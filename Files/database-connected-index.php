            ...
            <div class="status-grid">
                ...
                <div class="status-card <?php echo $db_connected ? 'success' : 'error'; ?>">
                    ...
                    <?php if ($db_connected): ?>
                        ...
                        <table class="info-table">
                            <tr>
                                <th>Host</th>
                                <td><?php echo htmlspecialchars($rds_hostname); ?></td>
                            </tr>
                            <tr>
                                <th>Database</th>
                                <td><?php echo htmlspecialchars($db_info['db_name']); ?></td>
                            </tr>
                            <tr>
                                <th>Version</th>
                                <td><?php echo htmlspecialchars($db_info['version']); ?></td>
                            </tr>
                            <tr>
                                <th>User</th>
                                <td><?php echo htmlspecialchars($db_info['user']); ?></td>
                            </tr>
                            <tr>
                                <th>Server Time</th>
                                <td><?php echo htmlspecialchars($db_info['current_time']); ?></td>
                            </tr>
                        </table>
                    <?php else: ?>
                        ...
                        <table class="info-table">
                            ...
                            <tr>
                                <th>Port</th>
                                <td><?php echo htmlspecialchars($rds_port); ?></td>
                            </tr>
                            <tr>
                                <th>Database</th>
                                <td><?php echo htmlspecialchars($rds_db_name); ?></td>
                            </tr>
                            <tr>
                                <th>Username</th>
                                <td><?php echo htmlspecialchars($rds_username); ?></td>
                            </tr>
                        </table>
                    <?php endif; ?>
                </div>
                ...
                <div class="status-card success">
                    ...
                    <table class="info-table">
                        <tr>
                            <th>Instance ID</th>
                            <td><?php echo $instance_id ?: 'N/A'; ?></td>
                        </tr>
                        <tr>
                            <th>Availability Zone</th>
                            <td><?php echo $availability_zone ?: 'N/A'; ?></td>
                        </tr>
                        <tr>
                            <th>Instance Type</th>
                            <td><?php echo $instance_type ?: 'N/A'; ?></td>
                        </tr>
                        <tr>
                            <th>Hostname</th>
                ...
                <div class="status-card success">
                    ...
                    <table class="info-table">
                        ...
                        <tr>
                            <th>MySQL</th>
                            <td><?php echo $db_connected ? '✅ Connected' : '❌ Disconnected'; ?></td>
                        </tr>
                        <tr>
                            <th>PHP</th>
                            <td>✅ <?php echo PHP_VERSION; ?></td>
                        ...
                        <tr>
                            <th>Auto Scaling</th>
                            <td>✅ Configured (2-8 instances)</td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="status-card">
                    ...
                    <table class="info-table">
                        <tr>
                            <th>RDS_HOSTNAME</th>
                            <td><?php echo $_SERVER['RDS_HOSTNAME'] ?? 'Not Set'; ?></td>
                        </tr>
                        <tr>
                            <th>RDS_PORT</th>
                            <td><?php echo $_SERVER['RDS_PORT'] ?? 'Not Set'; ?></td>
                        </tr>
                        <tr>
                            <th>RDS_DB_NAME</th>
                            <td><?php echo $_SERVER['RDS_DB_NAME'] ?? 'Not Set'; ?></td>
                        </tr>
                        <tr>
                            <th>RDS_USERNAME</th>
                            <td><?php echo $_SERVER['RDS_USERNAME'] ?? 'Not Set'; ?></td>
                        </tr>
                        <tr>
                            <th>RDS_PASSWORD</th>
                            <td><?php echo isset($_SERVER['RDS_PASSWORD']) ? '***Set***' : 'Not Set'; ?></td>
                        </tr>
                    </table>
                </div>
            </div>
